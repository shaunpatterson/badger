...
// per-call closure allocation. The slice is pre-sized to the final count
// to skip growslice; in dgraph's posting list rollup this saves 4 growslice
// allocs per iterator construction at typical 6-memtable depth.
